...
public class SessionTableModel extends DefaultTableModel {
	...
	public void setMode(Mode m){
		final ArrayList<PlanningPokerSession> a = SessionStash.getInstance().getSessions();
		switch(m){
			case ALL:
				this.refreshSessions(a);
				break;
			case CLOSED:
				final ArrayList<PlanningPokerSession> b = new ArrayList<PlanningPokerSession>();
				...
				break;
			case OPEN:
				final ArrayList<PlanningPokerSession> b2 = new ArrayList<PlanningPokerSession>();
				for(int i = 0; i < a.size(); ++i){
