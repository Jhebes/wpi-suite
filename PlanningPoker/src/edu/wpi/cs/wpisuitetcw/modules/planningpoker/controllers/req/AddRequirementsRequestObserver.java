 ...
 */
public class AddRequirementsRequestObserver implements RequestObserver {

	/** The controller managing the request */
	protected AddRequirementController controller;
	 ...
	 */
	public AddRequirementsRequestObserver(
		AddRequirementController addRequirementController) {
