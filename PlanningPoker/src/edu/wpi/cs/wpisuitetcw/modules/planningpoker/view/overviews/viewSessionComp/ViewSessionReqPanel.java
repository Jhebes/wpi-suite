...
public class ViewSessionReqPanel extends JPanel {
	...
	public ViewSessionReqPanel(ViewSessionPanel parentPanel, PlanningPokerSession s) {
		...
		l = new ViewSessionReqPanelListeners.AddRequirement(this);
		this.addRequirementToAll.addActionListener(
		// new AddRequirementController(this));
				l);
		// Move Selected Requirements to the RIght
		l = new ViewSessionReqPanelListeners.MoveSelectedToSession(this);
		this.moveRequirementToSession.addActionListener(
		// new MoveRequirementToCurrentSessionController(this.session, this)
				l);

		// Move Selected Requirements to the Left
		l = new ViewSessionReqPanelListeners.MoveSelectedToAll(this);
		this.moveRequirementToAll.addActionListener(
		// new MoveRequirementToAllController(this.session, this)
				l);

		// Move all the requiremnents to the Right
		l = new ViewSessionReqPanelListeners.MoveAllToSession(this);
		this.moveAllRequirementsToSession.addActionListener(
		// new MoveAllRequirementsToCurrentSessionController(this.session, this)
				l);

		// Move all requirements to the left
		l = new ViewSessionReqPanelListeners.MoveAllToAll(this);
		this.moveAllRequirementsToAll.addActionListener(
		// new MoveAllRequirementsToAllController(this.session, this)
				l);
