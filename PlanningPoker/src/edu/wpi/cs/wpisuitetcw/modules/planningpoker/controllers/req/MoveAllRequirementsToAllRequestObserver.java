 ...
 */
public class MoveAllRequirementsToAllRequestObserver implements RequestObserver {

	/** The controller managing the request */
	protected MoveAllRequirementsToAllController controller;

	/**
	 * Constructs the observer
	 * 
	 * @param moveAllRequirementsToAllController
