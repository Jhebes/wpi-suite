 ...
 * 
 * This panel should be used when clients needs a name and a description box as
 * an integrated unit
 */
public class NameDescriptionPanel extends JPanel {
	...
	public NameDescriptionPanel() {
		...
		final JScrollPane descriptionFrame = new JScrollPane(
	...
	public NameDescriptionPanel(boolean hasName) {
		...
		descriptionTextField.setPreferredSize(new Dimension(400, 350));
		setLayout(new MigLayout("fill, inset 0", "", "0[][][][grow]0"));
